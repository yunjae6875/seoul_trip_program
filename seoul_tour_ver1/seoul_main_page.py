...
"border-radius: 60px;")
        ...
        self.map_widget_4 = QtWidgets.QWidget(self.frame_29)
        self.map_widget_4.setMinimumSize(QtCore.QSize(0, 754))
        self.map_widget_4.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.map_widget_4.setStyleSheet("background-color: rgb(231, 231, 231);")
        self.map_widget_4.setObjectName("map_widget_4")
        self.label_5 = QtWidgets.QLabel(self.map_widget_4)
        self.label_5.setGeometry(QtCore.QRect(250, 690, 71, 21))
        self.label_5.setObjectName("label_5")
        self.frame_30 = QtWidgets.QFrame(self.map_widget_4)
        self.frame_30.setGeometry(QtCore.QRect(30, 40, 533, 60))
...
"border-radius:15px;")
        ...
        self.label_8.setPixmap(QtGui.QPixmap("qt_img/magnifier.png"))
        ...
        self.verticalLayout_27.addWidget(self.map_widget_4)
...
"인기있는 음식점들만 소개해 드립니다."))
        ...
        self.label_5.setText(_translate("MainWindow", "지도 나올곳"))
