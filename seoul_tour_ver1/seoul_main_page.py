...
"}")
        ...
        self.lineEdit_3.setMinimumSize(QtCore.QSize(560, 66))
...
"border-radius: 60px;")
        ...
        self.check_btn = QtWidgets.QPushButton(self.frame_30)
        ...
        self.horizontalLayout_27.addWidget(self.check_btn)
...
"이름을 알려주세요!"))
        ...
        self.lineEdit_3.setPlaceholderText(_translate("MainWindow", "ex)19980625"))
...
"인기있는 음식점들만 소개해 드립니다."))
        ...
        self.map_place_btn.setText(_translate("MainWindow", "숙박업소"))
        self.map_lodge_btn.setText(_translate("MainWindow", "관광명소"))
