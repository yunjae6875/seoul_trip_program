...
"border-radius: 60px;")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../img/magnifier.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.check_btn.setIcon(icon2)
        ...
        self.frame_30.setMinimumSize(QtCore.QSize(522, 57))
        ...
        self.map_lineEdit.setMinimumSize(QtCore.QSize(0, 60))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.map_lineEdit.setFont(font)
        self.map_lineEdit.setObjectName("map_lineEdit")
        self.horizontalLayout_27.addWidget(self.map_lineEdit)
