...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(0, 0, 600, 850))
...
"    border-radius:20px;}")
        ...
        self.frame_15.setMaximumSize(QtCore.QSize(16777215, 350))
...
"    font: 20pt;")
        ...
        self.admit_btn = QtWidgets.QPushButton(self.frame_14)
        self.admit_btn.setMinimumSize(QtCore.QSize(560, 66))
        self.admit_btn.setMaximumSize(QtCore.QSize(560, 16777215))
        self.admit_btn.setStyleSheet("border-radius:15px;\n"
"border:1px solid black;\n"
"    font: 20pt;")
        self.admit_btn.setObjectName("admit_btn")
        self.verticalLayout_14.addWidget(self.admit_btn)
...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 536, 566))
...
"    border-top-right-radius: 20px;")
        ...
        self.back_5_btn_2 = QtWidgets.QPushButton(self.frame_30)
        self.back_5_btn_2.setMinimumSize(QtCore.QSize(60, 60))
        self.back_5_btn_2.setMaximumSize(QtCore.QSize(60, 60))
        self.back_5_btn_2.setStyleSheet("background-color: rgba(255, 255, 255, 0);")
        self.back_5_btn_2.setText("")
        self.back_5_btn_2.setIcon(icon4)
        self.back_5_btn_2.setIconSize(QtCore.QSize(60, 60))
        self.back_5_btn_2.setObjectName("back_5_btn_2")
        self.horizontalLayout_28.addWidget(self.back_5_btn_2)
        ...
        self.map_lineEdit_2 = QtWidgets.QLineEdit(self.frame_30)
        self.map_lineEdit_2.setMinimumSize(QtCore.QSize(50, 60))
        self.map_lineEdit_2.setMaximumSize(QtCore.QSize(520, 16777215))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.map_lineEdit_2.setFont(font)
        self.map_lineEdit_2.setStyleSheet("border-radius:15px;\n"
"border:1px solid black;")
        self.map_lineEdit_2.setObjectName("map_lineEdit_2")
        self.horizontalLayout_28.addWidget(self.map_lineEdit_2)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../img/magnifier.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.check_btn_2.setIcon(icon5)
        ...
        self.map_food_btn_2 = QtWidgets.QPushButton(self.frame_26)
        self.map_food_btn_2.setMinimumSize(QtCore.QSize(140, 45))
        self.map_food_btn_2.setMaximumSize(QtCore.QSize(140, 45))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.map_food_btn_2.setFont(font)
        self.map_food_btn_2.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius:15px;\n"
"border:1px solid black;")
        self.map_food_btn_2.setObjectName("map_food_btn_2")
        self.horizontalLayout_18.addWidget(self.map_food_btn_2)
        self.map_lodge_btn_2 = QtWidgets.QPushButton(self.frame_26)
        self.map_lodge_btn_2.setMinimumSize(QtCore.QSize(140, 45))
        self.map_lodge_btn_2.setMaximumSize(QtCore.QSize(140, 45))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.map_lodge_btn_2.setFont(font)
        self.map_lodge_btn_2.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius:15px;\n"
"border:1px solid black;")
        self.map_lodge_btn_2.setObjectName("map_lodge_btn_2")
        self.horizontalLayout_18.addWidget(self.map_lodge_btn_2)
        self.map_place_btn_2 = QtWidgets.QPushButton(self.frame_26)
        self.map_place_btn_2.setMinimumSize(QtCore.QSize(140, 45))
        self.map_place_btn_2.setMaximumSize(QtCore.QSize(140, 45))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.map_place_btn_2.setFont(font)
        self.map_place_btn_2.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius:15px;\n"
"border:1px solid black;")
        self.map_place_btn_2.setObjectName("map_place_btn_2")
        self.horizontalLayout_18.addWidget(self.map_place_btn_2)
        ...
        self.frame_23.setGeometry(QtCore.QRect(10, 50, 581, 661))
...
"인기있는 음식점들만 소개해 드립니다."))
        ...
        self.map_lineEdit_2.setPlaceholderText(_translate("MainWindow", "각 구별 핫스팟을 보여드려요!"))
        self.map_food_btn_2.setText(_translate("MainWindow", "음식점"))
        self.map_lodge_btn_2.setText(_translate("MainWindow", "숙박업소"))
        self.map_place_btn_2.setText(_translate("MainWindow", "관광명소"))
